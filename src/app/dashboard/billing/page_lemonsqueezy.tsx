...
const CHECKOUT_URLS = {
    ...
    pro: 'https://bagasystudio.lemonsqueezy.com/checkout/buy/YOUR_PRO_CHECKOUT_ID',
    business: 'https://bagasystudio.lemonsqueezy.com/checkout/buy/YOUR_BUSINESS_CHECKOUT_ID',
};
